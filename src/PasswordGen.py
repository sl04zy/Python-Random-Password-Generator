...
If you are seeing this message, means the program was unable to find
the packages he needed to work proprely.
        """)
    ...
    print(f"{Fore.RED}Restarting the program, please wait....{Fore.RESET}")
    sleep(5.5)
    os.system('cls')
    Auth()
